...
namespace Hierarchy2
{
	...
	public class ObjectCustomizationPopup : EditorWindow
	{
		...
		private HierarchyLocalData hierarchyLocalData;
		...
		private void OnEnable()
		{
			...
			if(hierarchyLocalData.TryGetCustomRowData(gameObject, out CustomRowItem customRowItem) == false)
			{
