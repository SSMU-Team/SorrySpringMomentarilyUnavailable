...
namespace Hierarchy2
{
	...
	{
		private HierarchyCanvas canvas;
		private Color backgroundColor =
			EditorGUIUtility.isProSkin ? new Color32(60, 60, 60, 255) : new Color32(203, 203, 203, 255);
		private Color borderColor = new Color32(40, 40, 40, 255);

		private bool IsSelectionsSameScene()
		{
			UnityEngine.SceneManagement.Scene scene = Selection.activeGameObject.scene;
		...
		public void Canvas(HierarchyCanvas canvas)
		{
			this.canvas = canvas;
		}
	}
